...
function xportcsv(fields){
		...
		if(newfields == null){
			newfields = {section : $('select[name=section-export] option:selected').val(),page : 1,limit:500};
		}						
		importURL = Symphony.Context.get('symphony')+ '/extension/importcsv/export/';		
		var request = jQuery.ajax({
			...
			success: function(data, textStatus){					
				if(data['progress'] == 'success'){					
					...
					var file = data['file'];
					var url = Symphony.Context.get('symphony')+ '/extension/importcsv/download/?file='+file;
